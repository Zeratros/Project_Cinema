...
title = ''
df = pd.read_csv("C:/Users/kirill/Desktop/DataFev23/Projet_2/modules/table_filtre.tsv", sep='\t')
...
with st.sidebar:
    ...
    recommandations = df_ml.iloc[indices.flatten()][["primaryTitle",'startYear','averageRating','numVotes','primaryName']].values.tolist()
    recommandations_df = pd.DataFrame(recommandations, columns=['films_proches','startYear','averageRating','numVotes','primaryName'])
